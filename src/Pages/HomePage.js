...
function HomePage() {    
    return (
       ...
       <h1>Hi, <span>I'am Archana Krishnan</span></h1>
...
<div className="row">         
  <a className='btn btn-primary block' rel="noreferrer" href='https://github.com/Archana636' target='_blank'>
    GitHub <GitHubIcon />
  </a>
  
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  
  <a className='btn btn-primary block' rel="noreferrer" href='https://drive.google.com/file/d/12MVLpXfw2qXHA_25DAF254HG7NrxeU_n/view?usp=sharing' target='_blank'>
    Resume <GetAppIcon />
  </a>        
</div> 
{/* </div> */}
